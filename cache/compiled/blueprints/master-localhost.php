...
return [
    ...
    'timestamp' => 1766935218,
    'checksum' => '15e1dfac1433974bbbbf32d7aaee0cdd',
    'files' => [
        ...
        'user/themes' => [
            'themes/kirikiri' => [
                'file' => 'user/themes/kirikiri/blueprints.yaml',
                'modified' => 1766862039
            ],
            'themes/quark' => [
    ...
    'data' => [
        'items' => [
            ...
            'themes.kirikiri.dropdown' => [
                'type' => '_parent',
                'name' => 'themes.kirikiri.dropdown',
                'form_field' => false
            ],
            'themes.kirikiri.dropdown.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.kirikiri.dropdown.enabled',
                'validation' => 'loose'
            ],
            'themes.quark' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'themes' => [
                'kirikiri' => [
                    'dropdown' => [
                        'enabled' => 'themes.kirikiri.dropdown.enabled'
                    ]
                ],
                'quark' => [
